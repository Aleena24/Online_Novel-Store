...
<body>
        ...
        <header id="header" class="header-scroll top-header headrom">
			...
			<?php $ress= mysqli_query($db,"select * from subcat where s_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/back/product.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src="admin/images/'.$rows['image'].'" alt="">'; ?></figure>
                                </div>
                            </div>
			  ...
			  <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="subcat.php">Choose Category</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="product.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your Novel</a></li>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="product.php?res_id_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["p_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              Novels <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  
									$stmt = $db->prepare("select * from product where s_id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='product.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['p_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/images/product/'.$product['img'].'" alt="novel logo">'; ?></a>
                                            </div>
