            ...
            <div class="navbar-header">
                ...
                <div class="navbar-collapse">
                    ...
                    <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/general/user-icn.png" alt="admin" class="profile-pic" /></a>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <span><i class="fa fa-archive f-s-40" aria-hidden="true"></i></span>
                                </div>
                                <div class="media-body media-text-right">
